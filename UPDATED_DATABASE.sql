...
CREATE TABLE `Seasons` (
  `seasonID` INT(11) NOT NULL PRIMARY KEY,
...
CREATE TABLE `OrderProducts` (
  ...
  CONSTRAINT `orderproducts_1` FOREIGN KEY (`productID`) REFERENCES `Products` (`productId`) ON DELETE NO ACTION,
  CONSTRAINT `orderproducts_2` FOREIGN KEY (`orderID`) REFERENCES `Orders` (`orderID`) ON DELETE CASCADE,
  CONSTRAINT `orderproducts_3` FOREIGN KEY (`seasonID`) REFERENCES `Orders` (`seasonID`) ON DELETE CASCADE   
);
